...
export class ApiService {
  ...
  constructor(private storage: Storage, private http: HttpClient, private networkService: NetworkService, private offlineManager: OfflineManagerService) { }

  getUsers(forceRefresh: boolean = false): Observable<any> {
    console.log('api service getCurrentNetworkStatus');
